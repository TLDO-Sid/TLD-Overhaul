...
("arena_1", "Battle/Arena.mp3", mtf_sit_arena, 0),
...
("captured", "Battle/Capture.mp3", mtf_persist_until_finished, 0),

("defeated_by_neutral","TLD_Killed.mp3",mtf_module_track|                 mtf_persist_until_finished|mtf_sit_killed, 0),
("defeated_by_neutral_2", "Battle/Capture.mp3",                            mtf_persist_until_finished|mtf_sit_killed, 0),
("defeated_by_neutral_3", "Battle/Capture.mp3",                            mtf_persist_until_finished|mtf_sit_killed, 0),
("killed_by_swadian", "Battle/Capture.mp3" ,                  mtf_culture_good|mtf_persist_until_finished|mtf_sit_killed, 0),
...
("neutral_infiltration", "Infiltrate.mp3", mtf_sit_town_infiltrate, 0),
# ("outdoor_beautiful_land", "outdoor_beautiful_land.ogg", mtf_sit_travel, mtf_sit_night|mtf_sit_tavern),
("retreat", "Battle/Capture.mp3", mtf_persist_until_finished|mtf_sit_killed, 0),
...
# New tracks (Sid)
("TLD_Iron_Hill_Mine_2",   "TLD_Iron_Hill_Mine_2.mp3",   mtf_module_track, mtf_sit_town),
("TLD_Battle_Dwarves_2",   "Battle/TLD_Battle_Dwarves_2.mp3",   mtf_module_track, mtf_sit_fight|mtf_sit_ambushed),
