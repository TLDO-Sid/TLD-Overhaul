...
("lamedon_auxila"  ,"Lamedon Auxilia"   ,icon_footman_lamedon|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_veteran_of_lamedon,1,1),(trp_warrior_of_lamedon,1,5),(trp_footman_of_lamedon,4,8)]), #31-71
("lossarnach_auxila","Lossarnach Auxilia",icon_lossarnach_axeman_icon|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_heavy_axeman_of_lossarnach,1,1),(trp_axeman_of_lossarnach,1,3),(trp_footman_of_lossarnach,2,4),(trp_woodsman_of_lossarnach,4,8)]), #25-71
...
("lorien_scouts"   ,"Lothlorien Scouts"    ,icon_lorien_elf_a |carries_goods(1)|pf_show_faction,0,fac_lorien  ,scout_personality,[(trp_lothlorien_archer,1,2),(trp_lothlorien_veteran_scout,3,4),(trp_lothlorien_scout,3,4)]), #31-62
...
("imladris_scouts","Dunedain Rangers",icon_ithilien_ranger|carries_goods(1)|pf_show_faction,0,fac_imladris,scout_personality,[(trp_dunedain_master_ranger,1,1),(trp_dunedain_veteran_ranger,1,2),(trp_dunedain_ranger,2,3)]), #37-65
("dale_scouts"     ,"Dale Scouts"          ,icon_footman_dale  |carries_goods(2)|pf_show_faction,0,fac_dale    ,scout_personality,[(trp_dale_archer,1,1),(trp_dale_scout,2,6),(trp_dale_militia,4,8)]), #25-49 weak
("esgaroth_scouts" ,"Esgaroth Scouts"    ,icon_ithilien_ranger|carries_goods(2)|pf_show_faction,0,fac_dale    ,scout_personality,[(trp_laketown_guard_archer,1,1),(trp_laketown_archer,1,3),(trp_laketown_bowman,4,6)]), #41-67 stronger than dale
...
("iron_scouts"     ,"Iron Hills Lookouts"  ,icon_dwarf        |carries_goods(2)|pf_show_faction,0,fac_dwarf   ,scout_personality,[(trp_iron_hills_archer,1,1),(trp_iron_hills_infantry,1,3),(trp_iron_hills_lookout,4,6)]), #41-63
...
("rhun_scouts"      ,"Rhun Scouts"      ,icon_easterling_horseman|carries_goods(1)|pf_show_faction,0,fac_rhun    ,scout_personality,[(trp_balchoth_cavalry,1,3),(trp_rhun_cavalry,3,6),(trp_rhun_scout,5,8)]), #44-86 fast and very capable
...
("imladris_raiders","Rivendell Foragers" ,icon_knight_rivendell|carries_goods(2)|pf_show_faction,0,fac_imladris,soldier_personality,[(trp_noldorin_horseman,2,4),(trp_rivendell_horseman,3,8),(trp_rivendell_footman,6,12)]), #97-194 # less but stronger troops, cavalry
("lorien_raiders"  ,"Lothlorien Foragers",icon_lorien_elf_a |carries_goods(2)|pf_show_faction,0,fac_lorien  ,soldier_personality,[(trp_lothlorien_warden,1,1),(trp_lothlorien_archer,7,15),(trp_lothlorien_footman,6,12)]), #71-152
...
("dale_raiders"    ,"Dale Foragers"      ,icon_knight_dale  |carries_goods(2)|pf_show_faction,0,fac_dale    ,soldier_personality,[(trp_girions_guard_of_dale,1,1),(trp_merchant_guard_of_dale,3,8),(trp_dale_bowmen,3,8),(trp_dale_scout,4,12)]), #64-144
...
("gundabad_raiders","Gundabad Raiders"  ,icon_orc_tribal    |carries_goods(2)|pf_show_faction,0,fac_gundabad,soldier_personality,[(trp_goblin_north_clan_rider,1,3),(trp_warg_skirmisher_gundabad,6,12),(trp_skirmisher_gundabad,12,18),(trp_orc_gundabad,18,32),(trp_troll_of_moria,0,1)]), #128-234 was 93-163
("rhun_raiders"    ,"Rhun Raiders"      ,icon_easterling_horseman|carries_goods(1)|pf_show_faction,0,fac_rhun    ,soldier_personality,[(trp_balchoth_cavalry,1,3),(trp_rhun_cavalry,5,10),(trp_rhun_archer,5,10),(trp_rhun_infantry,8,16)]), #124-264, was 100-184
...
("imladris_patrol","Dunedain Patrol"  ,icon_knight_rivendell  |carries_goods(0)|pf_show_faction,0,fac_imladris,soldier_personality,[(trp_knight_of_arnor,1,1),(trp_arnor_horsemen,4,10),(trp_high_swordsman_of_arnor,3,5),(trp_arnor_master_at_arms,8,20),(trp_arnor_squire,3,5),(trp_dunedain_bowman,6,12)]), #252-554
("lorien_patrol"  ,"Lothlorien Patrol",icon_lorien_elf_b   |carries_goods(2)|pf_show_faction,0,fac_lorien  ,soldier_personality,[(trp_lothlorien_elite_warden,2,4),(trp_lothlorien_warden,12,25)]), #312-615
...
("dale_patrol"    ,"Dale Patrol"      ,icon_footman_dale   |carries_goods(2)|pf_show_faction,0,fac_dale    ,soldier_personality,[(trp_girions_guard_of_dale,1,1),(trp_dale_marchwarden,4,8),(trp_dale_bill_master,3,8),(trp_dale_billman,4,10),(trp_dale_archer,6,12),(trp_dale_man_at_arms,6,12)]), #242-518
("esgaroth_patrol","Esgaroth Patrol"  ,icon_footman_dale   |carries_goods(2)|pf_show_faction,0,fac_dale    ,soldier_personality,[(trp_laketown_marine,3,5),(trp_laketown_guard_archer,3,6),(trp_laketown_shipman,4,10),(trp_laketown_archer,5,12),(trp_laketown_bowman,6,12)]), #242-518
...
("iron_patrol"   ,"Iron Hills Patrol" ,icon_dwarf          |carries_goods(2)|pf_show_faction,0,fac_dwarf   ,soldier_personality,[(trp_grors_guard,1,1),(trp_iron_hills_bowman,8,16),(trp_iron_hills_spearman,5,10),(trp_iron_hills_battle_infantry,8,20),(trp_iron_hills_lookout,10,25)]), #257-542
...
("lossarnach_patrol","Lossarnach Patrol",icon_lossarnach_axeman_icon|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_lossarnach_leader,1,1),(trp_heavy_axeman_of_lossarnach,3,8),(trp_heavy_footman_of_lossarnach,4,10),(trp_archer_of_gondor,8,20),(trp_axeman_of_lossarnach,8,20)]), #213-503
...
("lamedon_patrol" ,"Lamedon Patrol"  ,icon_lamedon_horseman|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_lamedon_leader,1,1),(trp_knight_of_lamedon,6,14),(trp_champion_of_lamedon,3,6),(trp_veteran_of_lamedon,8,20),(trp_warrior_of_lamedon,10,24)]), #253-541 #InVain 270-600, added more cavalry
...
#Northern war
("dale_war_party"  ,"Dale_War_Party"   ,icon_dale_army_x3        |carries_goods(3)|pf_show_faction,0,fac_dale   ,soldier_personality,[(trp_dale_man_at_arms,8,13),(trp_dale_veteran_warrior,8,20),(trp_barding_bowmen_of_dale,8,16),(trp_dale_archer,5,20),(trp_dale_billman,10,25),(trp_merchant_squire_or_dale,4,15)]), # NOT USED and unbalanced 383-953
...
("rhun_war_party"  ,"Rhun_War_Party"   ,icon_easterling_horseman_x3|carries_goods(3)|pf_show_faction,0,fac_rhun   ,soldier_personality,[(trp_rhun_heavy_cavalry,2,4),(trp_balchoth_cavalry,5,10),(trp_rhun_heavy_archer,8,16),(trp_rhun_heavy_halberdier,8,16),(trp_rhun_huntsman,12,24),(trp_rhun_militia,12,24)]), #358-716 was 260-552
...
("rohan_company"   ,"Rohan Company"     ,icon_knight_rohan        ,0,fac_rohan   ,soldier_personality,[(trp_elite_rider_of_rohan,25,25),(trp_elite_skirmisher_of_rohan,25,25),(trp_elite_spearman_of_rohan,25,25),(trp_eorl_guard_of_rohan,12,12),(trp_thengel_guard_of_rohan,12,12),(trp_captain_of_rohan,1,1)]),
("imladris_company","Rivendell Company" ,icon_rivendell_elf       ,0,fac_imladris,soldier_personality,[(trp_elf_captain_of_rivendell,1,1),(trp_rivendell_footman,20,33),(trp_noldorin_spearman,8,18),(trp_noldorin_swordsman,8,18),(trp_rivendell_archer,20,33)]),
("lorien_company"  ,"Lothlorien Company",icon_lorien_elf_b        ,0,fac_lorien  ,soldier_personality,[(trp_elf_captain_of_lothlorien,1,1),(trp_lothlorien_footman,30,30),(trp_lothlorien_archer,30,30),(trp_galadhrim_archer,5,5),(trp_galadhrim_spearman,5,5),(trp_lothlorien_light_swordsman,30,30)]),
...
("dale_company"    ,"Dale Company"      ,icon_knight_dale         ,0,fac_dale    ,soldier_personality,[(trp_dale_archer,20,20),(trp_barding_bowmen_of_dale,20,20),(trp_dale_veteran_warrior,20,20),(trp_dale_bill_master,20,20),(trp_girions_guard_of_dale,20,20)]),
...
("imladris_elite_company","Rivendell Elite Company" ,icon_knight_rivendell    ,0,fac_imladris,soldier_personality,[(trp_elf_captain_of_rivendell   ,1,1),(trp_noldorin_elite_archer,17,34),(trp_noldorin_elite_spearman,17,34),(trp_noldorin_elite_swordsman,17,34)]),
("lorien_elite_company"  ,"Lothlorien Elite Company",icon_lorien_elf_b_x3     ,0,fac_lorien  ,soldier_personality,[(trp_noldorin_commander   ,1,1),(trp_galadhrim_elite_archer,13,25),(trp_lothlorien_elite_warden,13,25),(trp_galadhrim_elite_swordsman,13,25),(trp_galadhrim_elite_spearman,13,25)]),
...
("dale_elite_company"    ,"Dale Elite Company"      ,icon_dale_army_x3        ,0,fac_dale    ,soldier_personality,[(trp_dale_bill_master           ,13,25),(trp_dale_marchwarden,13,25),(trp_girions_guard_of_dale,13,25),(trp_barding_bowmen_of_dale,13,25),(trp_knight_5_1,13,25)]),
...
("imladris_caravan","Rivendell Caravan" ,icon_mule         |carries_goods(10)|pf_show_faction,0,fac_imladris,prisoner_train_personality,[(trp_rivendell_horseman,1,4),(trp_noldorin_archer,4,10),(trp_rivendell_archer,12,24),(trp_rivendell_veteran_scout,10,16),(trp_rivendell_mounted_scout,14,24)]), # strength 254-508
("lorien_caravan"  ,"Lothlorien Caravan",icon_mule         |carries_goods(10)|pf_show_faction,0,fac_lorien  ,prisoner_train_personality,[(trp_lothlorien_horseman,2,6),(trp_lothlorien_footman,4,10),(trp_lothlorien_archer,14,30),(trp_lothlorien_veteran_scout,12,18),(trp_lothlorien_light_swordsman,16,28)]), # strength 298-600
...
("dale_caravan"    ,"Dale Caravan"      ,icon_mule         |carries_goods(10)|pf_show_faction,0,fac_dale    ,prisoner_train_personality,[(trp_merchant_protector_of_dale,1,5),(trp_dale_archer,5,10),(trp_merchant_guard_of_dale,4,8),(trp_dale_warrior,8,16),(trp_dale_scout,18,30)]), # strength 198-399
...
("imladris_p_train","Rivendell Prisoner Train" ,icon_mule         |pf_show_faction,0,fac_imladris,prisoner_train_personality,[(trp_rivendell_footman,2,4), (trp_rivendell_archer,2,4), (trp_rivendell_mounted_scout,6,10), (trp_rivendell_veteran_scout,6,8), (trp_rivendell_scout,25,35)]), # strength 138-216
("lorien_p_train"  ,"Lothlorien Prisoner Train",icon_mule         |pf_show_faction,0,fac_lorien  ,prisoner_train_personality,[(trp_lothlorien_archer,6,10), (trp_lothlorien_light_swordsman,6,10), (trp_lothlorien_veteran_scout,6,10), (trp_lothlorien_scout,25,35)]), # strength 152-240
...
("dale_p_train"    ,"Dale Prisoner Train"      ,icon_mule         |pf_show_faction,0,fac_dale    ,prisoner_train_personality,[(trp_merchant_guard_of_dale,1,2), (trp_dale_warrior,1,2), (trp_dale_bowmen,1,2), (trp_dale_man_at_arms,4,6), (trp_dale_scout,6,10), (trp_dale_militia,21,25)]), # strength 100-150
...
("lamedon_reinf_b"   ,"_",0,0,fac_commoners,0,[(trp_footman_of_lamedon,4,8),(trp_warrior_of_lamedon,1,2),]),
("lamedon_reinf_c"   ,"_",0,0,fac_commoners,0,[(trp_veteran_of_lamedon,4,8),]),
("lossarnach_reinf_a","_",0,0,fac_commoners,0,[(trp_footman_of_lossarnach,2,4),(trp_woodsman_of_lossarnach,5,10),]),
("lossarnach_reinf_b","_",0,0,fac_commoners,0,[(trp_axeman_of_lossarnach,4,8),(trp_heavy_footman_of_lossarnach,1,2),]),
("lossarnach_reinf_c","_",0,0,fac_commoners,0,[(trp_heavy_axeman_of_lossarnach,4,8),]),
...
#Rhun
("rhun_reinf_a"    ,"_",0,0,fac_commoners,0,[(trp_rhun_scout,1,2),(trp_rhun_militia,2,3),(trp_rhun_clansman,5,10),]),
("rhun_reinf_b"    ,"_",0,0,fac_commoners,0,[(trp_balchoth_cavalry,3,5),(trp_rhun_cavalry,1,2),(trp_rhun_archer,2,4),]),
("rhun_reinf_c"    ,"_",0,0,fac_commoners,0,[(trp_rhun_heavy_cavalry,2,4),(trp_rhun_heavy_infantry,1,2),(trp_rhun_heavy_halberdier,2,4),]),
#Khand
...
("lorien_reinf_a"  ,"_",0,0,fac_commoners,0,[(trp_lothlorien_footman,1,2),(trp_lothlorien_veteran_scout,1,2),(trp_lothlorien_scout,2,4),(trp_lothlorien_light_swordsman,2,4),]),
("lorien_reinf_b"  ,"_",0,0,fac_commoners,0,[(trp_lothlorien_archer,2,4),(trp_lothlorien_footman,2,4),]),
("lorien_reinf_c"  ,"_",0,0,fac_commoners,0,[(trp_galadhrim_archer,2,4),(trp_galadhrim_swordsman,1,2),(trp_lothlorien_warden,1,2),]),
#Imladris - two trees, Rivendell favored over Dunedain (6-12, 4-8, 4-8)
("imladris_reinf_a","_",0,0,fac_commoners,0,[(trp_rivendell_veteran_scout,1,2),(trp_rivendell_footman,1,1),(trp_dunedain_trained_scout,1,2),(trp_rivendell_scout,2,4),(trp_dunedain_scout,2,4)]),
("imladris_reinf_b","_",0,0,fac_commoners,0,[(trp_rivendell_archer,2,4),(trp_dunedain_ranger,1,1),(trp_noldorin_spearman,1,2),(trp_arnor_man_at_arms,0,1),]),
("imladris_reinf_c","_",0,0,fac_commoners,0,[(trp_noldorin_horseman,2,4),(trp_arnor_horsemen,1,1),(trp_noldorin_elite_spearman,1,2),(trp_dunedain_veteran_ranger,0,1),]),
...
#Dale (7-14, 5-10, 4-8)
("dale_reinf_a"    ,"_",0,0,fac_commoners,0,[(trp_dale_man_at_arms,1,2),(trp_dale_scout,1,2),(trp_dale_militia,5,10),]),
("dale_reinf_b"    ,"_",0,0,fac_commoners,0,[(trp_merchant_squire_or_dale,0,1),(trp_dale_bowmen,3,5),(trp_dale_pikeman,1,2),(trp_dale_warrior,1,2),(trp_laketown_warden,0,1),(trp_laketown_shipman,0,1),]),
("dale_reinf_c"    ,"_",0,0,fac_commoners,0,[(trp_merchant_protector_of_dale,2,4),(trp_dale_billman,1,2),(trp_dale_veteran_warrior,1,2),(trp_laketown_marine,0,1),]),
#Erebor (7-14, 5-10, 3-7)
("dwarf_reinf_a"   ,"_",0,0,fac_commoners,0,[(trp_dwarven_warrior,1,2),(trp_dwarven_lookout,1,2),(trp_dwarven_apprentice,5,10),]),
("dwarf_reinf_b"   ,"_",0,0,fac_commoners,0,[(trp_dwarven_scout,1,3),(trp_dwarven_hardened_warrior,3,5),(trp_iron_hills_infantry,1,2)]),
("dwarf_reinf_c"   ,"_",0,0,fac_commoners,0,[(trp_dwarven_bowman,1,2),(trp_dwarven_axeman,1,2),(trp_dwarven_spearman,1,2),(trp_dwarven_pikeman,0,1),]),
...
#Lake-Town (7-14, 4-10, 1-6)
("laketown_reinf_a"    ,"_",0,0,fac_commoners,0,[(trp_laketown_militia,1,2),(trp_laketown_bowman,1,2),(trp_riverman,5,10),]),
("laketown_reinf_b"    ,"_",0,0,fac_commoners,0,[(trp_laketown_archer,2,4),(trp_laketown_warden,1,2),(trp_laketown_shipman,1,2),(trp_merchant_squire_or_dale,0,1),(trp_dale_pikeman,0,1),]),
("laketown_reinf_c"    ,"_",0,0,fac_commoners,0,[(trp_laketown_guard_archer,1,2),(trp_laketown_guard,0,1),(trp_laketown_marine,0,1),(trp_merchant_protector_of_dale,0,1),(trp_dale_billman,0,1),]),
#Iron Hills (7-14, 5-10, 3-7)
("ironhills_reinf_a"   ,"_",0,0,fac_commoners,0,[(trp_iron_hills_watchman,1,2),(trp_iron_hills_lookout,1,2),(trp_iron_hills_miner,5,10),]),
("ironhills_reinf_b"   ,"_",0,0,fac_commoners,0,[(trp_iron_hills_scout,1,3),(trp_iron_hills_infantry,3,5),(trp_dwarven_hardened_warrior,1,2)]),
("ironhills_reinf_c"   ,"_",0,0,fac_commoners,0,[(trp_iron_hills_bowman,1,2),(trp_iron_hills_battle_infantry,1,2),(trp_iron_hills_spearman,1,2),(trp_iron_hills_pikeman,0,1),]),
#Volunteer templates
#MV guidelines:
...
("isengard_recruits"  ,"_",0,0,fac_commoners,0,[(trp_uruk_snaga_of_isengard,2,6),(trp_orc_snaga_of_isengard,1,1),(trp_dunnish_wildman,1,2)]), #two T1
...
("rhun_recruits"      ,"_",0,0,fac_commoners,0,[(trp_rhun_clansman,1,4),(trp_rhun_scout,1,1)]), #T1 and T2
("khand_recruits"     ,"_",0,0,fac_commoners,0,[(trp_easterling_youth,2,5)]),
("umbar_recruits"     ,"_",0,0,fac_commoners,0,[(trp_corsair_youth,3,6)]),
("lorien_recruits"    ,"_",0,0,fac_commoners,0,[(trp_lothlorien_scout,1,3),(trp_lothlorien_veteran_scout,1,1)]), #two T1
...
("dale_recruits"      ,"_",0,0,fac_commoners,0,[(trp_dale_militia,1,4),(trp_merchant_squire_or_dale,1,1),(trp_rhovanion_regent,0,1)]), #T1 and T2
("laketown_recruits"  ,"_",0,0,fac_commoners,0,[(trp_riverman,1,2),(trp_laketown_militia,0,1),(trp_laketown_bowman,0,1)]), #T1 and T2
