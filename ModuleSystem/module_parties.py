...
#TLD TOWNS
    ...
    ("town_tarnost"         ,"Tarnost",     icon_castle_gondor_small|pf_tld_down, no_menu, pt_none, fac_gondor,0,ai_bhvr_hold,0,(-12.15, 40.35),[],170),
    ("town_erech"           ,"Erech",       icon_castle_gondor_small|pf_tld_down, no_menu, pt_none, fac_gondor,0,ai_bhvr_hold,0,( 28.17,  9.34),[],170),
    ("town_pinnath_gelin"  ,"Pinnath_Gelin",icon_gondortown         |pf_tld_down, no_menu, pt_none, fac_gondor,0,ai_bhvr_hold,0,( 55.99, 30.76),[],170),
    ...
    ("town_calembel"        ,"Calembel",    icon_gondortown         |pf_tld_down, no_menu, pt_none, fac_gondor,0,ai_bhvr_hold,0,( 2.90, 27.27),[],50),
# Rohan towns
...
# Woodelves towns
    ("town_thranduils_halls","Thranduil's_Halls",icon_thranduil|pf_tld_down, no_menu, pt_none, fac_woodelf,0,ai_bhvr_hold,0,(-43.08,-221.05),[],170),
    ("town_woodelf_camp"     ,"Woodelf_Camp",        icon_tree |pf_tld_down, no_menu, pt_none, fac_woodelf,0,ai_bhvr_hold,0,(-44.5,-193.24),[],170),
    ("town_woodelf_west_camp","Woodelf_West_Camp",   icon_tree |pf_tld_down, no_menu, pt_none, fac_woodelf,0,ai_bhvr_hold,0,(-20.25,-219.92),[],170),
# Woodmen and Beorning towns   
    ("town_woodsmen_village","Woodsmen_Village", icon_village_a    |pf_tld_down, no_menu, pt_none, fac_beorn,0,ai_bhvr_hold,0,(-43.94,-175.75),[],170),
    ...
    ("town_beorn_house"     ,"Beorn's House",    icon_smallvillage |pf_tld_down, no_menu, pt_none, fac_beorn,0,ai_bhvr_hold,0,(-17.02,-193.55),[],170),
# Moria towns
...
# Haradrim towns
    ("town_harad_camp","Haradrim_Camp",    icon_haradcamp  |pf_tld_down, no_menu, pt_none, fac_harad,0,ai_bhvr_hold,0,(-52.82,77.56),[],170),
# Khand towns
    ("town_khand_camp","Khand_Camp",       icon_nomadcamp  |pf_tld_down, no_menu, pt_none, fac_khand,0,ai_bhvr_hold,0,(-79.5,-46.5),[],170),
# Umbar towns
...
# Dol Guldur towns
    ...
    ("town_dol_guldur_north_outpost","Dol_Guldur North Outpost",  icon_orctower  |pf_tld_down,   no_menu, pt_none, fac_guldur,0,ai_bhvr_hold,0,(-50.3,-165.64),[],170),
# Rhun towns
    ("town_rhun_main_camp","Main_Rhun_Camp",     icon_nomadcamp  |pf_tld_down, no_menu, pt_none, fac_rhun,0,ai_bhvr_hold,0,(-80.72,-203.04),[],170),
    ("town_rhun_south_camp","Rhun_Southern Outpost",  icon_nomadcamp  |pf_tld_down, no_menu, pt_none, fac_rhun,0,ai_bhvr_hold,0,(-83.64,-176.15),[],170),
    ("town_rhun_north_camp","Rhun_Northern Outpost",  icon_nomadcamp  |pf_tld_down, no_menu, pt_none, fac_rhun,0,ai_bhvr_hold,0,(-80.96,-220.06),[],170),
# Gundabad towns
    ("town_gundabad"            ,"Gundabad",                 icon_moria   |pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(35.7,-241.5),[],165),
    ("town_gundabad_ne_outpost" ,"Gundabad_NE_Outpost",      icon_orctower|pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(-7.35,-245.26),[],120),
    ("town_gundabad_nw_outpost" ,"Gundabad_NW_Outpost",      icon_orctower|pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(15.73,-245.46),[],270),
    ("town_goblin_north_outpost","Goblin Town",  			       icon_orctower|pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(25.87,-187.91),[],200),
    ("town_goblin_south_outpost","Goblin_Southern_Outpost",  icon_orctower|pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(35.5,-227.46),[],10),				#(18.9,-194.8),[],140),
    ("town_gundabad_m_outpost"  ,"Gundabad_Mirkwood_Outpost",icon_orctower|pf_tld_down, no_menu, pt_none, fac_gundabad,0,ai_bhvr_hold,0,(-4.99,-220.79),[],170),
# Dwarves towns
    ("town_erebor"       ,"Erebor",          icon_moria |pf_tld_down, no_menu, pt_none, fac_dwarf,0,ai_bhvr_hold,0,(-59.6,-226.4),[],130),
    ("town_ironhill_camp","Iron_Hills_Quarry",icon_camp  |pf_tld_down, no_menu, pt_none, fac_dwarf,0,ai_bhvr_hold,0,(-35.68,-248.4),[],170),
