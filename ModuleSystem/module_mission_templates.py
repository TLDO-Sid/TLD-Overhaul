...
## Enemy Reinforcement Triggers: 
  (5, 0, 0, [
      ...
      (else_try), #Dale
        ...
        (assign, ":enemy_archer_tier_1", "trp_rhun_infantry"),
        #(troop_get_upgrade_troop, ":enemy_archer_tier_2", "trp_rhun_infantry",0), 
...
(5, 0, 0, [
      ...
      (else_try), #Dale
        (assign, ":allies_melee_tier_1", "trp_dale_veteran_warrior"),
        #(troop_get_upgrade_troop, ":allies_melee_tier_2", "trp_merchant_guard_of_dale",0), #Commented out - If we want to upgrade allies too.
        (assign, ":allies_archer_tier_1", "trp_dale_scout"),
        #(troop_get_upgrade_troop, ":allies_archer_tier_2", "trp_dale_bowmen",0),   #Commented out - If we want to upgrade allies too.
        #(display_message, "@DEBUG: Dale Troops Spawned", color_bad_news),
      (try_end),
    ...
    (5, 0, ti_once, [
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (else_try),
            (assign, ":interloper_1", "trp_loke_gamp_rim"),
            (assign, ":interloper_2", "trp_rhun_heavy_infantry"),
        ...
        (else_try),
          ...
          (else_try),
            (assign, ":interloper_1", "trp_dale_scout"),
