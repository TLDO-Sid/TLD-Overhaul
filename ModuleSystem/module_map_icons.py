...
#  ("flagbearer_b",0,"flagbearer_b", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ...
  ("axemen",0,"bandits_x3", avatar_scale,snd_footstep_grass, 0.15, 0.173, 0), # for beornings (Sid)
...
#TLD army icons begin
  ...
  ("dale_army_x3",0,"dale_army_x3", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ...
  ("generic_knight_x3",0,"bandits_x3", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0), # BEORNINGS
  # combined icons end
  ...
  ("footman_dale",0,"footman_dale", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),  
...
#  ("knight_rohan_x5",0,"knight_rohan_x5", avatar_scale, snd_gallop, 0.15, 0.173, 0),
  ("knight_dale",0,"knight_dale", avatar_scale, snd_gallop, 0.15, 0.173, 0),
...
#TLD MAP ICONS BEGIN # BEGIN PLACE ICONS
  ...
  # party map banners, each followed by king vesion
   ...
   ("mfp_erech",0,"map_flag_erech_lord", banner_scale,0),
	 ("mfp_esgaroth",  0,"map_flag_esgaroth_lord", banner_scale,0),
 ...
 # for laketown  
   ("mfc_esgaroth",0,"map_flag_esgaroth", banner_scale,0),
