...
############################################# "Elves kick ass"
       ...
       (set_visitor, 0, "$g_player_troop"),
		...
		(set_visitors, 4, "trp_galadhrim_archer",			        5),
		(set_visitors, 5, "trp_galadhrim_elite_archer",			    5),
		(set_visitors, 6, "trp_lothlorien_warden",				    5),
		(set_visitors, 7, "trp_lothlorien_elite_warden",			5),
		(set_visitors, 8, "trp_lothlorien_light_swordsman",			5),
		(set_visitors, 9, "trp_lothlorien_footman",		            5),
		(set_visitors, 10, "trp_galadhrim_swordsman",		        5),
		(set_visitors, 11, "trp_galadhrim_elite_swordsman",			5),
		(set_visitors, 12, "trp_galadhrim_spearman",			    5),
		(set_visitors, 13, "trp_galadhrim_elite_spearman",		    5),
		(set_visitors, 14, "trp_lothlorien_horseman",			    5),
		(set_visitors, 15, "trp_galadhrim_horseman",			    5),
#		ENEMY
...
##########################################   SCENE 4 Start "Helms Deep defence"
       ...
       (modify_visitors_at_site, "$g_custom_battle_scene"),
       (set_visitor, 0, "$g_player_troop"),
       (troop_add_item, "$g_player_troop","itm_rohan_bow",0),
       (troop_add_item, "$g_player_troop","itm_rohan_arrows",0),
       (troop_equip_items, "$g_player_troop"),
## US     
		(set_visitors, 1, "trp_dismounted_skirmisher_of_rohan",				6),
		(set_visitors, 2, "trp_dismounted_elite_skirmisher_of_rohan",		6),
		(set_visitors, 3, "trp_helm_guard_of_rohan",			            6),
		...
		(set_visitors, 12, "trp_elite_spearman_of_rohan",					6),
		(set_visitors, 13, "trp_galadhrim_archer",					        8),
...
#		(set_visitors, 1, "trp_dale_scout",				    3),
		(set_visitors, 2, "trp_dale_bowmen",			    6),
		(set_visitors, 3, "trp_dale_archer",			    6),
...
##     enemy Rhun
		(set_visitors, 16, "trp_rhun_clansman",			    7),
		(set_visitors, 17, "trp_rhun_militia",			    7),
		(set_visitors, 18, "trp_rhun_infantry",			    7),
		(set_visitors, 19, "trp_rhun_heavy_infantry",	    7),
		(set_visitors, 20, "trp_rhun_heavy_halberdier",     7),

		(set_visitors, 21, "trp_rhun_infantry",		        7),
		(set_visitors, 22, "trp_rhun_heavy_infantry",       7),
		(set_visitors, 23, "trp_rhun_heavy_halberdier",     7),
		#inf
		(set_visitors, 24, "trp_rhun_militia",		        7),
		(set_visitors, 25, "trp_rhun_huntsman",		        7),
		(set_visitors, 26, "trp_rhun_archer",			    7),
		(set_visitors, 27, "trp_rhun_heavy_archer",		    7),
		#cav
		(set_visitors, 28, "trp_rhun_scout",                7),
		(set_visitors, 29, "trp_rhun_cavalry",              7),
		(set_visitors, 30, "trp_balchoth_cavalry",          7),
		(set_visitors, 31, "trp_rhun_heavy_cavalry",	    7),
...
## ENEMY
		...
		(set_visitors, 22, "trp_galadhrim_elite_archer",				3),
		(set_visitors, 23, "trp_rivendell_scout",						3),
		(set_visitors, 24, "trp_rivendell_veteran_scout",				3),
		(set_visitors, 25, "trp_rivendell_footman",					    3),
...
########################################## FOOTBALL  
   ...
   (else_try),########################################## TEST SCENE FOR DYNAMIC SCENERY  
		...
		(try_begin),
			...
			(eq,":gfac",5),(assign,":trp_good_min","trp_lothlorien_scout" ),(assign,":trp_good_max","trp_lothlorien_elite_warden"     ),(else_try),
			(eq,":gfac",6),(assign,":trp_good_min","trp_greenwood_scout"  ),(assign,":trp_good_max","trp_rivendell_knight"            ),(else_try),
		...
		(try_begin),
			(eq,":bfac",0),(assign,":trp_bad_min","trp_rhun_clansman"        ),(assign,":trp_bad_max","trp_loke_innas_rim"             ),(else_try),
...
( "start_eye_man",menu_text_color(0xFF000000)|mnf_disable_all_keys,
 ...
 ("start_rh",[],"RHUN, the barbarians from the East",            [(call_script,"script_start_as_one","trp_rhun_clansman"),            (jump_to_menu,"mnu_choose_gender"),]),
...
( "camp_cctest",0,
  ...
  [
	...
	[
		...
		(troop_add_item, "trp_player","itm_gon_lord"),
	]),
...
( "camp_mvtest",0,
  ...
  ("camp_mvtest_pimp",[],"Pimp me up first!",
    [(troop_raise_attribute, "trp_player",ca_strength,20),
     ...
     (troop_add_item, "trp_player","itm_gondor_bastard_sword",imod_masterwork),
     (troop_add_item, "trp_player","itm_gondor_hunter",imod_champion),
     (troop_add_item, "trp_player","itm_riv_helm_b",imod_lordly),
     (troop_add_item, "trp_player","itm_gon_lord",imod_lordly),
...
#		(troop_add_item, "trp_player","itm_bastard_sword_a",0),
		(troop_add_item, "trp_player","itm_numenor_bow",0),
      ...
      ("bandit_fortress_against_easterlings",[],"Defend the Fortress against the Siege",
       [(eq, "$g_encountered_party", "p_raft"),
	    ...
	    (store_div, ":high",":random_no",6),
      	(assign, ":cur_entry", 16),
				(try_for_range, ":unused", 0, 5),
					(set_visitors, ":cur_entry", "trp_rhun_militia",":low"),
					(val_add, ":cur_entry", 1),
				(try_end),
				(assign, ":cur_entry", 21),
				(try_for_range, ":unused", 0, 5),
					(set_visitors, ":cur_entry", "trp_rhun_heavy_halberdier",":low"),
					(val_add, ":cur_entry", 1),
				(try_end),
				(assign, ":cur_entry", 26),
				(try_for_range, ":unused", 0, 3),
					(set_visitors, ":cur_entry", "trp_loke_nar_rim",":mid"),
					(val_add, ":cur_entry", 1),
				(try_end),
				(assign, ":cur_entry", 29),
				(try_for_range, ":unused", 0, 3),
					(set_visitors, ":cur_entry", "trp_loke_innas_rim", ":high"),
					(val_add, ":cur_entry", 1),
				(try_end),
	      (set_battle_advantage, 0),
	      (assign, "$g_battle_result", 0),
		    ...
		    (modify_visitors_at_site,"scn_starting_quest"),
			 ...
			 (else_try),
			  	  (				eq,"$players_kingdom", "fac_rhun"),
  	  			  (set_visitors,2,"trp_dale_scout",       3),
	...
	("village_quest",0,
	 ...
	 #Randomize Raiders
	        ...
	        (else_try),
	          ...
	          (assign, ":bandit_troop_1", "trp_rhun_militia"),
	          (assign, ":bandit_troop_2", "trp_rhun_huntsman"),
	        (else_try),
	 ...
	 ("sb_defend_the_town",[
		...
		# Once checked, we then spawn the troop we want. For higher level players, they get upgraded.
   			...
   			# (else_try), #Dale
	   			...
	   			# (assign, ":allies_archer_tier_1", "trp_dale_bowmen"),
	   			# (troop_get_upgrade_troop, ":allies_archer_tier_2", "trp_dale_bowmen",0),   #Commented out - If we want to upgrade allies too.

	   			# (assign, ":enemy_melee_tier_1", "trp_rhun_militia"),
	   			# (troop_get_upgrade_troop, ":enemy_melee_tier_2", "trp_rhun_militia",0),
	   			# (assign, ":enemy_archer_tier_1", "trp_rhun_archer"),
	   			# (troop_get_upgrade_troop, ":enemy_archer_tier_2", "trp_rhun_archer",0), 
   			# (try_end),
	        ...
	        (set_visitor, 0, "trp_player"),
				(try_begin),
					(lt, ":level", 25),
						...
						#ally archers, entries 8-10
						(set_visitors, 8, "trp_dale_bowmen", 3),(set_visitors, 9, "trp_dale_bowmen", 3),(set_visitors, 10, "trp_dale_archer", 3),
						#enemy infantry, entries 12-17
						(set_visitors, 12, "trp_rhun_infantry", 5),(set_visitors, 13, "trp_rhun_infantry", 5),(set_visitors, 14, "trp_rhun_heavy_halberdier", 5),(set_visitors, 15, "trp_rhun_militia", 5),(set_visitors, 16, "trp_rhun_scout", 5),(set_visitors, 17, "trp_rhun_cavalry", 5),
						#enemy archers, entries 18-20
						(set_visitors, 18, "trp_rhun_archer", 5),(set_visitors, 19, "trp_rhun_heavy_archer", 5),(set_visitors, 20, "trp_loke_nar_rim", 5),
				...
				(else_try),
					(ge, ":level", 25),
						...
						(set_visitors, 8, "trp_dale_bowmen", 3),(set_visitors, 9, "trp_dale_bowmen", 3),(set_visitors, 10, "trp_dale_archer", 3),
						#enemy infantry, entries 12-17
						(set_visitors, 12, "trp_rhun_infantry", 5),(set_visitors, 13, "trp_rhun_heavy_halberdier", 5),(set_visitors, 14, "trp_rhun_heavy_halberdier", 5),(set_visitors, 15, "trp_loke_gamp_rim", 5),(set_visitors, 16, "trp_rhun_cavalry", 5),(set_visitors, 17, "trp_rhun_heavy_cavalry", 5),
						#enemy archers, entries 18-20
						(set_visitors, 18, "trp_rhun_heavy_archer", 5),(set_visitors, 19, "trp_rhun_archer", 5),(set_visitors, 20, "trp_rhun_heavy_archer", 5),
	 ...
	 ("sb_attack_the_town",[
		...
		# #Once checked, we then spawn the troop we want. For higher level players, they get upgraded.
   			...
   			# (else_try), #Rhun
	   			...
	   			# (assign, ":allies_melee_tier_1", "trp_rhun_militia"),
	   			# #(troop_get_upgrade_troop, ":allies_melee_tier_2", "trp_rhun_militia",0), #Commented out - If we want to upgrade allies too.
	   			# (assign, ":allies_archer_tier_1", "trp_rhun_archer"),
	   			# #(troop_get_upgrade_troop, ":allies_archer_tier_2", "trp_rhun_archer",0),   #Commented out - If we want to upgrade allies too.
	   			...
	   			# (assign, ":enemy_archer_tier_1", "trp_dale_bowmen"),
	   			# (troop_get_upgrade_troop, ":enemy_archer_tier_2", "trp_dale_bowmen",0), 
   			# (try_end),
	        ...
	        (set_visitor, 0, "trp_player"),
				(try_begin),
					(lt, ":level", 25),
						...
						#enemy archers, entries 8-10
						(set_visitors, 8, "trp_dale_bowmen", 4),(set_visitors, 9, "trp_dale_bowmen", 4),(set_visitors, 10, "trp_dale_archer", 4),
						#ally infantry, entries 12-17
						(set_visitors, 12, "trp_rhun_archer", 5),(set_visitors, 13, "trp_rhun_archer", 5),(set_visitors, 14, "trp_rhun_heavy_archer", 5),(set_visitors, 15, "trp_rhun_huntsman", 5),(set_visitors, 16, "trp_rhun_scout", 5),(set_visitors, 17, "trp_rhun_heavy_halberdier", 5),
						#ally archers, entries 18-20
						(set_visitors, 18, "trp_rhun_infantry", 5),(set_visitors, 19, "trp_rhun_infantry", 5),(set_visitors, 20, "trp_rhun_heavy_infantry", 5),
				...
				(else_try),
					(ge, ":level", 25),
						...
						#enemy archers, entries 8-10
						(set_visitors, 8, "trp_dale_bowmen", 3),(set_visitors, 9, "trp_dale_bowmen", 3),(set_visitors, 10, "trp_barding_bowmen_of_dale", 3),
						#ally infantry, entries 12-17
						(set_visitors, 12, "trp_rhun_archer", 5),(set_visitors, 13, "trp_rhun_archer", 5),(set_visitors, 14, "trp_rhun_heavy_archer", 5),(set_visitors, 15, "trp_rhun_huntsman", 5),(set_visitors, 16, "trp_rhun_scout", 5),(set_visitors, 17, "trp_rhun_heavy_halberdier", 5),
						#ally archers, entries 18-20
						(set_visitors, 18, "trp_rhun_infantry", 5),(set_visitors, 19, "trp_rhun_infantry", 5),(set_visitors, 20, "trp_rhun_heavy_infantry", 5),
