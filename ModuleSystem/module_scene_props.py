...
("horse_riv_warhorse2",sokf_invisible,"rivendell_warhorse02","0", [(ti_on_init_scene_prop,[
    (store_trigger_param_1, ":instance_no"),(prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
  (spawn_horse,"itm_elven_horse", 0),(agent_set_stand_animation, reg0, "anim_horse_stand"),])]),
...
("horse_rohirrim_courser2",sokf_invisible,"rohan_horse03","0", [(ti_on_init_scene_prop,[
    (store_trigger_param_1, ":instance_no"),(prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
  (spawn_horse,"itm_rohirrim_hunter2", 0),(agent_set_stand_animation, reg0, "anim_horse_stand"),])]),
...
("horse_thengel_warhorse",sokf_invisible,"rohan_warhorse02","0", [(ti_on_init_scene_prop,[
    (store_trigger_param_1, ":instance_no"),(prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
  (spawn_horse,"itm_rohirrim_heavy_warhorse", 0),(agent_set_stand_animation, reg0, "anim_horse_stand"),])]),
...
#InVain submod props																							   
( "Gondor_MT_black_circular_wall"                 ,0,"InVain_MT_circular_wall","bo_isen_circular_wall",[]),
( "Gondor_MT_black_tower"                         ,0,"InVain_MT_tower_a","bo_isen_tower_a",[]),
#InVain submod props end
...
##### ESGAROTH BANNER #####
("banner_esgaroth", 0, "b_arms_esgaroth", "0", []),

##### GONDOR FOUNTAIN GUARD #####
("troop_castle_f_guard",sokf_invisible,"arrow_helper_blue","0", [(ti_on_init_scene_prop,[
    (store_trigger_param_1, ":instance_no"),
    (lt, "$g_encountered_party_2", 0), #don't spawn guards in siege battles
    (prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
    (assign, ":troop", "trp_guard_of_the_fountain_court"),
    (spawn_agent, ":troop"),(agent_set_team, reg0, 0),(agent_set_stand_animation, reg0, "anim_stand"),])]),

##### WARDEN OF MEDUSELD #####
("troop_meduseld_guard",sokf_invisible,"arrow_helper_blue","0", [(ti_on_init_scene_prop,[
    (store_trigger_param_1, ":instance_no"),
    (lt, "$g_encountered_party_2", 0), #don't spawn guards in siege battles
    (prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
    (assign, ":troop", "trp_warden_of_methuseld"),
    (spawn_agent, ":troop"),(agent_set_team, reg0, 0),(agent_set_stand_animation, reg0, "anim_stand"),])])
