...
(try_for_range, ":troop", "trp_lothlorien_archer", "trp_lothlorien_footman"),
...
(try_end),
    ...
    (else_try),
    (eq, "$troop_to_pick", "trp_galadhrim_archer"),
    (val_add, "$no_lothlorien_veteran_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_galadhrim_elite_archer"),
    ...
    (else_try),
    (eq, "$troop_to_pick", "trp_lothlorien_footman"),
    (val_add, "$no_lothlorien_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_galadhrim_swordsman"),
    (val_add, "$no_lothlorien_veteran_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_galadhrim_elite_swordsman"),
    ...
    (else_try),
    (eq, "$troop_to_pick", "trp_lothlorien_horseman"),
...
(assign, "$guard_troop7", "trp_elite_spearman_of_rohan"),
(assign, "$guard_troop8", "trp_elite_spearman_of_rohan"),
...
(assign, "$formation_troop_13", "trp_lothlorien_footman"),
(assign, "$formation_troop_14", "trp_galadhrim_swordsman"),
(assign, "$formation_troop_15", "trp_galadhrim_elite_swordsman"),
(assign, "$formation_troop_16", "trp_galadhrim_elite_swordsman"),
...
(else_try),
    ...
    (try_end),
    (party_add_leader, "$eohere_party_id", "trp_eorl_guard_of_rohan", 10),
...
(store_script_param_1, ":local0"),
    ...
    (eq, ":local0", "trp_lord_malvogil"),
    (troop_add_items, ":local0", "itm_iron_greaves", 1),
    (troop_add_items, ":local0", "itm_gondor_helm", 1),
    ...
    (eq, ":local0", "trp_lord_orthalion"),
    (troop_add_items, ":local0", "itm_iron_greaves", 1),
    (troop_add_items, ":local0", "itm_gon_citadel_guard_helm", 1),
    (troop_add_items, ":local0", "itm_gondor_hunter", 1),
    (troop_add_items, ":local0", "itm_gondorian_ornate_shield", 1),
    (else_try),
    (eq, ":local0", "trp_lord_aravir"),
    ...
    (eq, ":local0", "trp_lord_hirluin"),
    (troop_add_items, ":local0", "itm_iron_greaves", 1),
    (troop_add_items, ":local0", "itm_gondor_light_helm", 1),
