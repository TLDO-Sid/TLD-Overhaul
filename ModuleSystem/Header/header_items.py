...
itcf_carry_axe_back                                  = 0x0000000170000000 # 0x0000000100000000
...
itcf_carry_back                                      = 0x0000000100000000 # 0x0000000170000000
...
itcf_carry_spear                                     = 0x0000000170000000 # 0x0000000000000000
itcf_carry_none                                      = 0x0000000000000000 # nothing :)
...
itc_greataxe   = itc_parry_polearm| itcf_overswing_polearm |itcf_slashright_polearm|itcf_slashleft_polearm # flag for two handed axes (Sid)
