...
subfac_hornburg = 5
# Lake-Town
subfac_laketown = 1 # Sid
subfac_ironhills = 1 # Sid
...
banner_meshes_end_minus_one = mesh_banner_f_end

arms_meshes_begin = mesh_arms_a01
arms_meshes_end_minus_one = mesh_arms_f_end
...
banner_scene_props_end_minus_one = spr_banner_f_end
...
faction_init = [
(fac_gondor  ,4500,mtf_culture_gondor       ,[trp_gondor_lord  ,trp_knight_1_2    ],[trp_gondor_commoner,     trp_gondor_militiamen,       trp_footmen_of_gondor,       trp_gondor_swordsmen,          trp_veteran_knight_of_gondor, 			trp_archer_of_gondor  	  		 ],[pt_gondor_reinf_a,  pt_gondor_reinf_b,  pt_gondor_reinf_c,  pt_gondor_p_train],  spr_banner_a, icon_mfp_gondor,  [-1,                      trp_gondor_swordsmen,          trp_ranger_of_ithilien,       trp_gondor_swordsmen,           trp_gondor_swordsmen],            p_town_minas_tirith,    faction_side_good,theater_SE,p_advcamp_gondor),
(fac_rohan   ,4950,mtf_culture_rohan_goodmen,[trp_rohan_lord   ,trp_rohan_lord    ],[trp_rohan_youth,         trp_squire_of_rohan,         trp_rider_of_rohan,          trp_veteran_rider_of_rohan,    trp_eorl_guard_of_rohan, 				trp_skirmisher_of_rohan   		 ],[pt_rohan_reinf_a,   pt_rohan_reinf_b,   pt_rohan_reinf_c,   pt_rohan_p_train],   spr_banner_b, icon_mfp_rohan,   [-1,                      trp_footman_of_rohan,          trp_squire_of_rohan,       trp_dismounted_skirmisher_of_rohan,trp_eorl_guard_of_rohan],         p_town_edoras,          faction_side_good,theater_SW,p_advcamp_rohan),
(fac_isengard,5500,mtf_culture_orcs         ,[trp_isengard_lord,trp_knight_1_17   ],[trp_orc_snaga_of_isengard,trp_uruk_hai_of_isengard, trp_large_uruk_hai_of_isengard,trp_fighting_uruk_hai_warrior, trp_white_hand_rider, 					trp_uruk_hai_tracker      		 ],[pt_isengard_reinf_a,pt_isengard_reinf_b,pt_isengard_reinf_c,pt_isengard_p_train],spr_banner_s, icon_mfp_isengard,[trp_orc_of_isengard,     trp_fighting_uruk_hai_warrior, trp_uruk_hai_tracker,         trp_large_uruk_hai_of_isengard, trp_fighting_uruk_hai_champion],  p_town_isengard,        faction_side_hand,theater_SW,p_advcamp_isengard),
...
(fac_rhun    ,3500,mtf_culture_evilmen      ,[trp_rhun_lord    ,trp_rhun_lord     ],[trp_rhun_clansman,       trp_rhun_scout,              trp_rhun_cavalry,            trp_rhun_heavy_cavalry,        trp_loke_innas_rim, 			            trp_rhun_scout      		     ],[pt_rhun_reinf_a,    pt_rhun_reinf_b,    pt_rhun_reinf_c,    -1],                 spr_banner_f, icon_mfp_rhun,    [trp_rhun_clansman,       trp_rhun_heavy_halberdier,     trp_rhun_scout,               trp_rhun_heavy_archer,          trp_loke_gamp_rim],               p_town_rhun_main_camp,  faction_side_eye ,theater_N ,p_advcamp_rhun),
...
(fac_umbar   ,2100,mtf_culture_evilmen      ,[trp_umbar_lord   ,trp_umbar_lord    ],[trp_corsair_youth,       trp_corsair_warrior,         trp_corsair_marauder,        trp_corsair_veteran_marauder,  trp_corsair_elite_marauder, 				trp_marksman_of_umbar     		 ],[pt_umbar_reinf_a,   pt_umbar_reinf_b,   pt_umbar_reinf_c,   -1],                 spr_banner_g, icon_mfp_umbar,   [trp_corsair_warrior,     trp_corsair_night_raider,      trp_marksman_of_umbar,        trp_veteran_marksman_of_umbar,  trp_corsair_elite_marauder],      p_town_umbar_camp,      faction_side_eye ,theater_SE,p_advcamp_umbar),
(fac_lorien  ,3500,mtf_culture_elves        ,[trp_lorien_lord ,trp_lorien_marshall],[trp_lothlorien_scout,    trp_lothlorien_veteran_scout,trp_lothlorien_archer,       trp_galadhrim_archer,          trp_galadhrim_elite_archer, 			    trp_lothlorien_scout       		 ],[pt_lorien_reinf_a,  pt_lorien_reinf_b,  pt_lorien_reinf_c,  pt_lorien_p_train],  spr_banner_h, icon_mfp_lorien,  [-1,                      trp_lothlorien_archer,         trp_lothlorien_veteran_scout, trp_lothlorien_warden,          trp_galadhrim_elite_archer],      p_town_caras_galadhon,  faction_side_good,theater_C ,p_advcamp_lorien),
(fac_imladris,3300,mtf_culture_elves        ,[trp_imladris_lord,trp_imladris_lord ],[trp_rivendell_scout,     trp_rivendell_veteran_scout, trp_rivendell_footman,       trp_noldorin_swordsman,        trp_noldorin_horseman, 				    trp_rivendell_scout        		 ],[pt_imladris_reinf_a,pt_imladris_reinf_b,pt_imladris_reinf_c,pt_imladris_p_train],spr_banner_i, icon_mfp_imladris,[-1,                      trp_noldorin_spearman,         trp_rivendell_veteran_scout,  trp_rivendell_footman,          trp_noldorin_horseman],           p_town_imladris_camp,   faction_side_good,theater_C ,p_advcamp_imladris),
...
(fac_dale    ,3500,mtf_culture_rohan_goodmen,[trp_dale_lord    ,trp_dale_lord     ],[trp_dale_militia,        trp_dale_scout,              trp_dale_bowmen,             trp_dale_archer,               trp_girions_guard_of_dale, 				trp_dale_scout     			     ],[pt_dale_reinf_a,    pt_dale_reinf_b,    pt_dale_reinf_c,    pt_dale_p_train],    spr_banner_o, icon_mfp_dale,    [-1,                      trp_dale_bowmen,               trp_merchant_squire_or_dale,  trp_dale_warrior,               trp_dale_veteran_warrior],        p_town_dale,            faction_side_good,theater_N ,p_advcamp_dale),
(fac_dwarf   ,3500,mtf_culture_rohan_goodmen,[trp_dwarf_lord   ,trp_dwarf_lord    ],[trp_dwarven_apprentice,  trp_dwarven_warrior,         trp_dwarven_hardened_warrior,trp_dwarven_axeman,            trp_longbeard_axeman, 				    trp_dwarven_bowman               ],[pt_dwarf_reinf_a,   pt_dwarf_reinf_b,   pt_dwarf_reinf_c,   pt_dwarf_p_train],   spr_banner_p, icon_mfp_dwarf,   [-1,                      trp_dwarven_pikeman,           trp_dwarven_lookout,          trp_dwarven_expert_axeman,      trp_dwarven_halberdier],          p_town_erebor,          faction_side_good,theater_N ,p_advcamp_dwarf),
...
subfaction_data= [      
 ...
 (subfac_ethring      ,p_town_calembel     ,"Lamedon"   ,[trp_clansman_of_lamedon     ,trp_footman_of_lamedon          ,trp_warrior_of_lamedon          ],[pt_lamedon_reinf_a   ,pt_lamedon_reinf_b   ,pt_lamedon_reinf_c   ],[trp_lamedon_leader]),
 (subfac_lossarnach   ,p_town_lossarnach   ,"Lossarnach",[trp_woodsman_of_lossarnach  ,trp_axeman_of_lossarnach        ,trp_heavy_axeman_of_lossarnach  ],[pt_lossarnach_reinf_a,pt_lossarnach_reinf_b,pt_lossarnach_reinf_c],[trp_lossarnach_leader]),
 ...
 (subfac_laketown     ,p_town_esgaroth     ,"Esgaroth"  ,[trp_laketown_warden         ,trp_laketown_warden             ,trp_laketown_guard              ],[pt_laketown_reinf_a  ,pt_laketown_reinf_b  ,pt_laketown_reinf_c  ],[trp_laketown_guard]),
 (subfac_ironhills    ,p_town_ironhill_camp,"Iron_Hills",[trp_iron_hills_pikeman      ,trp_iron_hills_heavy_infantry   ,trp_iron_hills_halberdier       ],[pt_ironhills_reinf_a ,pt_ironhills_reinf_b ,pt_ironhills_reinf_c ],[trp_grors_guard]),
]
...
(p_town_esgaroth        ,pt_esgaroth_scouts,      -1,                 pt_esgaroth_patrol,  pt_dale_caravan),
(p_town_erebor          ,pt_dwarf_scouts,         pt_dwarf_raiders,	  pt_dwarf_patrol,     pt_dwarf_caravan),
(p_town_ironhill_camp   ,pt_iron_scouts,          -1,				  pt_iron_patrol,      pt_dwarf_caravan),
#Others evil
...
(p_town_linhir, [scn_linhir_center, scn_gondor_castle_b, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_linhir_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_gondor],[900],[2,8,2,8,2,8], str_income_med, garrison_limit_med, 1, tld_siegable_normal),
...
(p_town_edhellond, [scn_edhellond_center, scn_gondor_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_edhellond_siege, mesh_town_edhellond],
	[trp_barman_edhellond, trp_smith_edhellond, trp_merchant_edhellond, trp_elder_edhellond, pt_gondor_recruits, trp_knight_6_2, trp_walker_woman_gondor_bw,trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_b], 
...
(p_town_tarnost, [scn_tarnost_center, scn_gondor_castle_c, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_tarnost_siege, mesh_ui_default_menu_window],
	[trp_barman_tarnost, trp_smith_tarnost, trp_merchant_tarnost, trp_elder_tarnost, pt_gondor_recruits, trp_knight_6_1, trp_walker_woman_gondor_bw,trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_b], 
	[icon_mfc_gondor],[900],[4,4,4,6,4,8], str_income_med, garrison_limit_med, 1, tld_siegable_normal),
...
(p_town_caras_galadhon, [scn_caras_galadhon_center, -1, scn_elf_prison,scn_elf_tavern,scn_elf_arena,scn_forest_lorien2,mesh_town_caras_galadhon],
	[trp_barman_cgaladhon, trp_smith_cgaladhon, trp_merchant_cgaladhon, trp_elder_cgaladhon, pt_lorien_recruits, trp_lorien_lord, trp_lothlorien_scout, trp_lothlorien_archer, trp_lothlorien_footman, trp_galadhrim_archer], 
...
(p_town_cerin_dolen, [scn_cerin_dolen_center, -1, -1, -1, -1, scn_cerin_dolen_center, mesh_ui_default_menu_window],
	[trp_barman_cdolen, trp_smith_cdolen, trp_merchant_cdolen, trp_elder_cdolen, pt_lorien_recruits,  trp_lorien_lord, trp_lothlorien_scout, trp_lothlorien_archer, trp_lothlorien_footman, trp_galadhrim_archer], 
...
(p_town_cerin_amroth, [scn_cerin_amroth_center, -1, -1, -1, -1, scn_cerin_amroth_center, mesh_ui_default_menu_window],
	[trp_barman_camroth, trp_smith_camroth, trp_merchant_camroth, trp_elder_camroth, pt_lorien_recruits,  trp_lorien_lord, trp_lothlorien_scout, trp_lothlorien_footman, trp_lothlorien_archer, trp_galadhrim_archer], 
...
(p_town_woodelf_camp, [scn_woodelf_camp_center, -1, -1,-1,-1,scn_woodelf_camp_siege, mesh_town_goodcamp],
	...
	[icon_mfc_woodelf],[900],[2,1,4,1,4,1], str_income_low, garrison_limit_low, 2, tld_siegable_normal),
...
(p_town_imladris_camp, [scn_rivendell_camp_center, -1, -1,-1,-1,scn_rivendell_camp_siege,mesh_town_rivendell_camp],
	[-1, trp_smith_imladris, trp_merchant_imladris, trp_elder_imladris, pt_imladris_recruits, trp_imladris_lord, trp_rivendell_scout,trp_noldorin_spearman, trp_rivendell_footman,trp_arnor_man_at_arms], 
...
(p_town_troll_cave, [scn_troll_cave_center, -1, -1,-1,-1,scn_troll_cave_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_moria],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 1, tld_siegable_normal),
...
(p_town_dale, [scn_dale_center, scn_dale_castle, scn_rohan_prison,scn_rohan_tavern,scn_dale_arena, scn_dale_siege, mesh_ui_default_menu_window],
	[trp_barman_dale, trp_smith_dale, trp_merchant_dale, trp_elder_dale, pt_dale_recruits, trp_dale_lord,trp_townsman,trp_watchman,trp_townsman,trp_townsman], 
...
(p_town_esgaroth, [scn_esgaroth_center, scn_esgaroth_castle, scn_rohan_prison,scn_rohan_tavern,scn_dale_arena,scn_esgaroth_siege,mesh_town_esgaroth],
	[trp_barman_esgaroth, trp_smith_esgaroth, trp_merchant_esgaroth, trp_elder_esgaroth, pt_laketown_recruits, trp_knight_5_3,trp_townsman,trp_watchman,trp_townsman,trp_townsman], 
	[icon_mfc_esgaroth],[900],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 1, tld_siegable_normal),
...
(p_town_rhun_main_camp, [scn_north_rhun_camp_center, -1, -1,-1, scn_rhun_arena,scn_north_rhun_camp_siege, mesh_town_rhun_north],
	[-1, trp_smith_north_rhun, trp_merchant_north_rhun, trp_elder_rhun, pt_rhun_recruits,  trp_rhun_lord, trp_rhun_cavalry, trp_rhun_huntsman, trp_rhun_clansman, trp_rhun_infantry, ], 
...
(p_town_rhun_south_camp, [scn_rhun_south_camp_center, -1, -1,-1,-1,scn_rhun_south_camp_siege, mesh_town_rhun],
	[-1, trp_smith_north_rhun, trp_merchant_south_rhun, trp_elder_rhun_ac, pt_rhun_recruits,  trp_rhun_lord, trp_rhun_cavalry, trp_rhun_huntsman, trp_rhun_clansman, trp_rhun_infantry, ], 
...
(p_town_rhun_north_camp, [scn_rhun_north_camp_center, -1, -1,-1,-1,scn_rhun_north_camp_siege, mesh_town_rhun],
	[-1, trp_smith_rhun_ac, trp_merchant_north_rhun, trp_no_troop, pt_rhun_recruits,  trp_rhun_lord, trp_rhun_cavalry, trp_rhun_huntsman, trp_rhun_clansman, trp_rhun_infantry, ], 
...
(p_town_ironhill_camp, [scn_ironhill_camp_center, -1, -1,-1,-1,scn_ironhill_camp_center, mesh_town_goodcamp],
	[-1, trp_smith_ironhill, trp_merchant_ironhill, trp_no_troop, pt_dwarf_iron_recruits, trp_knight_5_7,trp_iron_hills_lookout, trp_iron_hills_watchman, trp_iron_hills_infantry, trp_iron_hills_miner], 
	[icon_mfc_dwarf],[900],[2,1,4,1,4,1], str_income_low, garrison_limit_low, 2, tld_siegable_normal),
...
(p_advcamp_rhun, [scn_advcamp_bad, -1, -1,-1,-1, scn_advcamp_bad, mesh_town_rhun_north],
	[-1, trp_smith_north_rhun, trp_merchant_north_rhun, trp_elder_rhun_ac, pt_rhun_recruits,  trp_rhun_lord, trp_rhun_cavalry, trp_rhun_huntsman, trp_rhun_clansman, trp_rhun_infantry, ], 
...
(p_advcamp_lorien, [scn_advcamp_good, -1, -1, -1, -1, scn_advcamp_good_siege, mesh_town_goodcamp],
	[-1, trp_smith_camroth, trp_merchant_camroth, trp_elder_lorien_ac, pt_lorien_recruits,  trp_lorien_lord, trp_lothlorien_scout, trp_lothlorien_footman, trp_lothlorien_archer, trp_galadhrim_archer], 
...
(p_advcamp_imladris, [scn_advcamp_good, -1, -1,-1,-1, scn_advcamp_good_siege, mesh_town_goodcamp],
	[-1, trp_smith_imladris, trp_merchant_imladris, trp_elder_imladris_ac, pt_imladris_recruits, trp_imladris_lord, trp_rivendell_scout,trp_noldorin_spearman, trp_rivendell_footman,trp_arnor_man_at_arms], 
...
(p_advcamp_dale, [scn_advcamp_good, -1, -1, -1, -1, scn_advcamp_good_siege, mesh_town_goodcamp],
	[-1, trp_smith_esgaroth, trp_merchant_esgaroth, trp_elder_dale_ac, pt_dale_recruits, trp_dale_lord,trp_dale_bill_master,trp_merchant_protector_of_dale,trp_dale_veteran_warrior,trp_dale_archer], 
...
(p_advcamp_dwarf, [scn_advcamp_good, -1, -1,-1,-1, scn_advcamp_good_siege, mesh_town_goodcamp],
	[-1, trp_smith_ironhill, trp_merchant_ironhill, trp_elder_dwarf_ac, pt_dwarf_recruits, trp_dwarf_lord,trp_dwarven_lookout, trp_dwarven_hardened_warrior, trp_iron_hills_infantry, trp_iron_hills_watchman], 
...
lords_spawn = [ (trp_knight_1_2, p_town_minas_tirith),
                ...
                (trp_knight_6_1, p_town_tarnost),
                (trp_knight_6_2, p_town_edhellond),
                (trp_knight_5_6, p_town_erebor),
                (trp_knight_5_7, p_town_ironhill_camp),
]
...
#fac_gondor
[(2,itm_cooking_cauldron,0),(3,itm_athelas_reward,0),(4,itm_gondor_hunter, imod_lordly), (5, itm_gon_hero, imod_reinforced), (6, itm_ring_a_reward, 0), (7, itm_silmarillion_reward, 0), (8, itm_westernesse1h_reward, 0), (9, itm_horn_gondor_reward, 0)],
#fac_dwarf
[(2,itm_cooking_cauldron,0),(3,itm_hammer_reward ,0),(4,itm_scroll_reward, 0), (5, itm_ring_a_reward, 0), (6, itm_dwarf_greaves_reward, 0), (7, itm_dwarf_helm_p, 0), (8, itm_dwarf_armor_reward, 0), (9, itm_dwarf_great_axe_reward, 0)],
#fac_rohan
...
#fac_imladris
[(2,itm_lembas          ,0),(3,itm_athelas_reward,0),(4,itm_elven_amulet_reward, 0), (5, itm_miruvor_reward, 0), (6, itm_ring_b_reward, 0), (7, itm_elven_horse, imod_champion), (8, itm_arnor_armor_reward, 0), (9, itm_riv_shield_reward, 0)],
#fac_woodelf
